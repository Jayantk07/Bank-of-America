	...
	<div class="container ">
        <h2 class="text-center pt-4 " style="color : white; ">Transaction</h2>
            <?php
                ...
                if(!$result)
                {
                    echo "Error : ".$sql."<br>".mysqli_error($conn); } $rows=mysqli_fetch_assoc($result); ?>
        <form method="post" name="tcredit" class="tabletext"><br>
            ...
            <br><br><br>
            <label style="color : rgb(243, 239, 239);"><b>Transfer To:</b></label>
            ...
            <br>
            <br>
            <label style="color : rgb(243, 239, 239);"><b>Amount:</b></label>
